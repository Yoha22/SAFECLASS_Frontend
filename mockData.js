...
const MOCK_DATA = {
  ...
  alerts: [
    ...
    },
    {
      ...
      classroom: "3B",
      cameraId: "CAM-02",
      timestamp: "2026-05-02T13:47:00",
      confidence: 0.76,
      status: "CONFIRMADA",
      discardReason: null,
      escalated: false,
      actions: [{ action: "Confirmada", user: "María Torres", timestamp: "2026-05-02T13:49:00" }],
    },
    {
      id: "ALT-003",
      type: "CAÍDA",
      classroom: "3A",
      cameraId: "CAM-01",
      timestamp: "2026-05-02T11:12:00",
      confidence: 0.94,
      status: "CONFIRMADA",
      discardReason: null,
      escalated: false,
      actions: [{ action: "Confirmada", user: "María Torres", timestamp: "2026-05-02T11:14:00" }],
    },
    {
      id: "ALT-004",
      type: "OTRO",
      ...
      confidence: 0.61,
      status: "DESCARTADA",
      discardReason: "Juego normal",
      escalated: false,
      actions: [{ action: "Descartada: Juego normal", user: "María Torres", timestamp: "2026-05-02T10:07:00" }],
    },
    {
      id: "ALT-005",
      type: "AGRESIÓN",
      ...
      escalated: true,
      actions: [
        { action: "Confirmada", user: "María Torres", timestamp: "2026-05-01T15:32:00" },
        { action: "Escalada a Coordinador", user: "María Torres", timestamp: "2026-05-01T15:33:00" },
      ],
    },
    {
      id: "ALT-006",
      ...
      classroom: "3B",
      cameraId: "CAM-02",
      timestamp: "2026-05-01T09:18:00",
      confidence: 0.91,
      status: "CONFIRMADA",
      discardReason: null,
      escalated: false,
      actions: [{ action: "Confirmada", user: "María Torres", timestamp: "2026-05-01T09:20:00" }],
    },
    {
      id: "ALT-007",
      type: "AISLAMIENTO",
      ...
      confidence: 0.68,
      status: "DESCARTADA",
      discardReason: "Actividad curricular",
      escalated: false,
      actions: [{ action: "Descartada: Actividad curricular", user: "María Torres", timestamp: "2026-04-30T14:08:00" }],
    },
  ],

  users: [
    { id: 1, name: "María Torres", email: "maria.torres@iecol.edu.co", role: "docente", active: true, lastSession: "2026-05-02T07:45:00" },
    { id: 2, name: "Carlos Mendoza", email: "carlos.mendoza@iecol.edu.co", role: "coordinador", active: true, lastSession: "2026-05-02T08:00:00" },
    { id: 3, name: "Ana Ruiz", email: "ana.ruiz@iecol.edu.co", role: "administrador", active: true, lastSession: "2026-05-01T16:30:00" },
  ...
  systemStats: {
    ...
    thresholdHistory: [
      ...
      { value: 0.72, user: "Ana Ruiz", timestamp: "2026-04-25T11:00:00" },
      { value: 0.75, user: "Ana Ruiz", timestamp: "2026-05-01T08:00:00" },
  ...
  coordinatorStats: {
    weekly: {
      ...
      heatmap: [
        // [hour_band, mon, tue, wed, thu, fri]
        ["7:00–8:00",  1, 0, 1, 0, 0],
        ["8:00–9:00",  2, 1, 2, 1, 2],
        ["9:00–10:00", 3, 2, 1, 2, 3],
        ["10:00–11:00",1, 1, 2, 3, 2],
        ["11:00–12:00",2, 3, 1, 1, 2],
        ["12:00–13:00",0, 1, 0, 0, 1],
        ["13:00–14:00",2, 1, 2, 1, 1],
        ["14:00–15:00",4, 2, 3, 2, 3],
        ["15:00–16:00",1, 1, 0, 1, 2],
      ],
      classroomRanking: [
        { name: "Aula 3A", count: 14 },
        { name: "Aula 3B", count: 10 },
        { name: "Aula 2C", count: 6 },
        { name: "Patio",   count: 4 },
      ],
    },
  },
